    ...
    return (
        ...
        border-b-4 border-error-600`}>
            ...
            <div className="flex flex-col item-start gap-2">
                <span className="text-white font-bold flex items-center justify-start w-full">
                    Title
                </span>
                <p className="text-white text-sm">Lorem  ipsum dolor sit amet, consectetur adipisicing elit. Quis, accusamus. </p>
            </div>
            ...
            <div className="flex flex-col items-center justify-between w-full gap-5">
                ...
                <div className="flex items-center justify-start flex-wrap gap-2 w-full">
                    <div className="flex items-center justify-center px-2 py-1 border border-gray-600 rounded-md bg-gray-600/22">
                        <span className="text-white text-xs">s1 asdasd</span>
                    </div>
                    <div className="flex items-center justify-center px-2 py-1 border border-gray-600 rounded-md bg-gray-600/22">
                        <span className="text-white text-xs">asdasda sda sdasd</span>
                    </div>
                    <div className="flex items-center justify-center px-2 py-1 border border-gray-600 rounded-md bg-gray-600/22">
                ...
                <div className="flex items-center justify-between w-full gap-2">
                    ...
                    <div className="flex items-center justify-center w-1/2">
                        <span className={`flex items-center justify-center w-[70%] py-1 rounded-md text-sm border border-success-500 text-success-500 bg-success-500/19`}>
                            Done
                        </span>
                    </div>
